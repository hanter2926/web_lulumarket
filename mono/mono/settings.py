...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-dev-only-change-this-key')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'vip.context_processors.site_settings',
            ],
        },
    },
]
...
STATIC_URL = '/static/'
# Allow both the existing 'stastic' folder and a conventional 'static' folder
STATICFILES_DIRS = [
    BASE_DIR / 'stastic',
    BASE_DIR / 'static',
]
